...
var {addCurrentAffairs, getCurrentAffairs, deleteCurrentAffairs, currentAffairsStatusUpdate} = require('../controller/currentAffairsController');
...
router.post('/addCurrentAffairs', upload.fields([{ name: "image" }]), addCurrentAffairs);
